...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var sportsCar = new Car() { HasTrunk = true, Make = "Ford", Model = "Mustang", Year = 1967 };
            var motorcycle = new Motorcycle() { HasSideCar = false, Make = "Honda", Model = "motorcycle", Year = 2012 };

            Vehicle truck = new Car() { HasTrunk = false, Make = "Ford", Model = "F150", Year = 2015 };

            Vehicle rzr = new Motorcycle() { HasSideCar = true, Make = "RZR", Model = "RZR", Year = 2020 };
